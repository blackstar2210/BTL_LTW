...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 31, 2018 lúc 05:11 AM
...
(26, 'Cốm Làng Vòng', 'Sô 20 - làng Vòng - Hà Nội', 'com-lang-vong.JPG', '', 'C:\\Users\\User\\Documents\\NetBeansProjects\\Example\\web\\PostImages\\com-lang-vong.JPG', 1, 1, 'ducanh'),
...
--
ALTER TABLE `post`
  MODIFY `post_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT cho bảng `user`
--
ALTER TABLE `user`
  MODIFY `user_id` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
